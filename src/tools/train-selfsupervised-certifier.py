...
from core.function import train_certifier
...
def main():
    ...
    train_dataset_event_real = eval('dataset.'+cfg.DATASET.DATASET)(
        cfg, cfg.DATASET.ROOT_ADVERSARIAL, cfg.DATASET.TRAIN_SET_ADVERSARIAL, False,
    ...
    pretrained = 'results/train/EventDataset/pose_hrnet/train-synthetic-nocertifier/checkpoint_event.pth'
